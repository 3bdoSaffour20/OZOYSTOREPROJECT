  ...
  <body class="home">
    ...
    <header class="primary-header container flex">
      <div class="header-inner-one flex">
        ...
        <nav>
          ...
          >
            ...
            <li>
              <a class="active fs-100 fs-montserrat bold-500" href="{{url('/shop')}}"
              >Shop</a>
            </li>
            <li>
      ...
      <div class="header-login flex">
        <p href="{{url('/logout')}}" class="large-btn bg-red text-white fs-poppins fs-50">logout</p>
    ...
    <!-- =============Footer Menu=================== -->
     <section class="footer grid">
         <div class="footer-logo grid">
          ...
          <div class="footer-menu grid">
            ...
            <ul>
              <li><a class="fs-montserrat text-black fs-200" href="{{url('home')}}">Home</a></li>
              <li><a class="fs-montserrat text-black fs-200" href="#">About</a></li>
              <li><a class="fs-montserrat text-black fs-200" href="{{url('shop')}}">Shop</a></li>
     ...
     <section class="copyRight">
      <p class="c-font fs-montserrat fs-200">© 2022 OzoyStore. All rights reserved.</p>
...
@foreach ($categories as $category)
  <div class="shop-category-list">
    <ul id="side-nav" class="sidebar-nav grid" data-category="false">
      <li>
        <a class="fs-montserrat text-black bold-500" href="{{url('view-category'.$category->name)}}">{{$category->name}}</a>
      </li>
    </ul>
  </div>
  @endforeach
