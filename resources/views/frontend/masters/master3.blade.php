...
<html lang="ar" dir="rtl">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('Main')}}/css/contactus.css" />
    <script src="{{ asset('Main')}}/js/index.js" defer></script>
    <script src="{{ asset('Main')}}/js/product.js" defer></script>
    <!-- custon style Sheet & JavaScript -->
  ...
  <body class="home">
    <header class="primary-header container flex">
      <div class="header-inner-one flex">
        <div class="logo">
          <img src="{{ asset('Main')}}/image/logo.png" alt="" />
        </div>
        <button
        ...
        <nav>
          ...
          >
            ...
            <li>
              <a class="fs-100 fs-montserrat bold-500" href="{{url('/shop')}}"
                >Shop</a
              >
            </li>
            <li>
    ...
    <section class="single-product grid">
      <div>
        <img src="{{ asset('Main')}}/image/product-img.jpg" alt="" />
      </div>
    ...
    <section class="best-Seller related-product">
      ...
      <div class="product grid">
        <img src="{{ asset('Main')}}/image/p-3.jpg" alt="" />
        <p class="fs-poppins bold-500">White EliteBook Tablet 810</p>
        <p class="fs-poppins bold-500">$995.00</p>
      ...
      <div class="product grid">
        <img src="{{ asset('Main')}}/image/p-4.jpg" alt="" />
      ...
      <div class="product grid">
        <img src="{{ asset('Main')}}/image/p-5.jpg" alt="" />
      ...
      <div class="product grid">
        <img src="{{ asset('Main')}}/image/p9.jpg" alt="" />
        <p class="fs-poppins bold-500">White EliteBook Tablet 810</p>
        <p class="fs-poppins bold-500">$995.00</p>
      ...
      <div class="product grid">
        <img src="{{ asset('Main')}}/image/p-7.jpg" alt="" />
      ...
      <div class="product grid">
        <img src="{{ asset('Main')}}/image/p8.png" alt="" />
        <p class="fs-poppins bold-500">Wireless Audio System Multiroom 360</p>
        <p class="fs-poppins bold-500">$995.00</p>
    ...
    <footer>
      ...
      <section class="brands grid">
        <div>
          <img src="{{ asset('Main')}}/image/br-1.png" alt="" />
        </div>
        <div>
          <img src="{{ asset('Main')}}/image/br-2.png" alt="" />
        </div>
        <div>
          <img src="{{ asset('Main')}}/image/br-3.png" alt="" />
        </div>
        <div>
          <img src="{{ asset('Main')}}/image/br-4.png" alt="" />
        </div>
        <div>
          <img src="{{ asset('Main')}}/image/br-5.png" alt="" />
        </div>
      </section>
      ...
      <section class="footer grid">
        ...
        <div class="footer-menu grid">
          ...
          <ul>
            <li>
              <a class="fs-montserrat text-black fs-200"  href="{{url('/home')}}">Home</a>
            </li>
            <li>
              <a class="fs-montserrat text-black fs-200" href="#">About</a>
            </li>
            <li>
              <a class="fs-montserrat text-black fs-200" href="{{url('/shop')}}">Shop</a>
            </li>
            <li>
